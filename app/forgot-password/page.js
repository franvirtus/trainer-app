    ...
    <div className="min-h-screen bg-slate-950 flex items-center justify-center p-4 font-sans">
      <div className="bg-white rounded-3xl shadow-2xl p-8 w-full max-w-md border-4 border-slate-800 relative">
        ...
        <div className="text-center mb-8 mt-4">
          ...
          <p className="text-slate-500 text-sm">Inserisce la tua email per ricevere il link</p>
        </div>
        ...
        {success ? (
            <div className="text-center py-8">
                ...
                <p className="text-slate-500 text-sm">Controlla la tua casella di posta (e lo spam). Troverai un link per resettare la password.</p>
