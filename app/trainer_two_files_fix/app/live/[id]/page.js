            ...
            <div className="mb-4 rounded-2xl border border-slate-800 bg-slate-950/80 p-3">
              ...
              <div className="grid grid-cols-3 gap-2">
                ...
                <div className="rounded-xl border border-slate-800 bg-slate-900 px-3 py-2">
                  ...
                  <div className="text-base font-black text-white break-words">
                    {String(currentLog?.actual_reps ?? "-")}
                  </div>
                </div>
                ...
                <div className="rounded-xl border border-slate-800 bg-slate-900 px-3 py-2">
                  ...
                  <div className="text-base font-black text-emerald-300 break-words">
                    {String(currentLog?.actual_weight ?? "-")}
                  </div>
                </div>
              </div>
