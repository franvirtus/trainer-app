...
import { Users, Plus, Search, LogOut, Dumbbell, User } from 'lucide-react';
...
export default function Dashboard() {
  ...
  const fetchData = async () => {
    ...
    // Cerca il nome corretto dai metadati utente
    setCoachName(user.user_metadata?.name || user.user_metadata?.full_name || user.email?.split('@')[0]);
