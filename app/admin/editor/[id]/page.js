      ...
      <div className="max-w-6xl mx-auto p-6 space-y-8">
        {activeTab === "profile" && (
            <div className="grid grid-cols-1 xl:grid-cols-3 gap-8 animate-in fade-in slide-in-from-bottom-2 duration-300">
                {/* ... (Codice Profilo Invariato - omesso per brevità, mantieni quello di prima o chiedimi se vuoi tutto il blocco) ... */}
                {/* NOTA: Per brevità qui sotto incollo SOLO la sezione PROGRAMS modificata, ma nel file finale devi avere tutto. 
                    Se vuoi tutto il file completo dimmelo, ma qui sotto metto la parte PROGRAMS aggiornata. */}
